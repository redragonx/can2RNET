...
def RNETsetProfile2():
	global can_socket
	cansend(can_socket,"051#00020000")

def RNETsetProfile3():
	global can_socket
	cansend(can_socket,"051#00030000")

def RNETsetMode2():
	global can_socket
	cansend(can_socket,"061#40000000")
	sleep(0.1)
	cansend(can_socket,"061#00010000")

def RNETsetMode3():
	global can_socket
	cansend(can_socket,"061#40010000")
	sleep(0.1)
	cansend(can_socket,"061#00000000")
...
def selectControlExploit():
	...
	rnet_joystick_id = wait_rnet_joystick_frame(start_time) #t=timeout time
